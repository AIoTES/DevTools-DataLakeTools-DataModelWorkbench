...
public class MailService {
    ...
    public MailService(SimlifeProperties jSimlifeProperties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(jSimlifeProperties.getMail().getFrom());
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, jSimlifeProperties.getMail().getBaseUrl());
