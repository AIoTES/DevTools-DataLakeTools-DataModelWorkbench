(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('model', {
            ...
            views: {
                'content@': {
                    templateUrl: 'dm-explorer-app/entities/model/models.html',
        ...
        .state('model-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'dm-explorer-app/entities/model/model-detail.html',
        ...
        .state('model-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'dm-explorer-app/entities/model/model-dialog.html',
        ...
        .state('model.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'dm-explorer-app/entities/model/model-delete-dialog.html',
